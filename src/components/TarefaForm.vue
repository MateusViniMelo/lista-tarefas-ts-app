    ...
    <form @submit.prevent="submit()">
        ...
        <div class="relative">
            <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                <i class="bi bi-plus-lg text-gray-500 dark:text-gray-400 text-xl"></i>
...
export default defineComponent({
    ...
    data() {
        return {
            tarefa: {} as ITarefa,
            tarefaIsSubmitting: false
        }
    },
    methods: {
        ...mapActions(tarefaStore, ["setTarefa"]),

        submit() {
            this.tarefaIsSubmitting = true
            this.setTarefa(this.tarefa).finally(() => { this.tarefaIsSubmitting = false })
        }
    }
